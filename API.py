...
##################################################################################################
#Load data
#Fichier à prédire qui a subi un préprocessing comme le fichier d'entraînement et qui a été réduit
filename = "DATA/Source/df_predict_ft_reduit.csv"
df_predict_ft_reduit = pd.read_csv(filename)

#Fichier pour application du modèle XGBoost (le fichier précédent a subi un KNN imputer et un standarscaler entraînés sur le fichier d'entraînement)
